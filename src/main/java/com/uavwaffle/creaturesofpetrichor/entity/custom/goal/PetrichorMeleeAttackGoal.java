package com.uavwaffle.creaturesofpetrichor.entity.custom.goal;

import com.uavwaffle.creaturesofpetrichor.entity.custom.type.PetrichorAttackingEntity;
...
public class PetrichorMeleeAttackGoal extends Goal {
    protected final PetrichorAttackingEntity mob;
    ...
    public PetrichorMeleeAttackGoal(PetrichorAttackingEntity mob, double speedModifier, boolean followingTargetEvenIfNotSeen) {
        this(mob, speedModifier, followingTargetEvenIfNotSeen, 1);
    }

    public PetrichorMeleeAttackGoal(PetrichorAttackingEntity mob, double speedModifier, boolean followingTargetEvenIfNotSeen, int attackRangeMultiplier) {
        this.mob = mob;
