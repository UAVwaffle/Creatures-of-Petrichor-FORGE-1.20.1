...
import com.uavwaffle.creaturesofpetrichor.entity.custom.type.PetrichorSlowFallEntity;
...
public class WanderingLanternEntity extends PetrichorSlowFallEntity {
    ...
    public static final RawAnimation ATTACK_ANIMATION = RawAnimation.begin().then("animation.wandering_lantern.attack", Animation.LoopType.PLAY_ONCE);
