...
public abstract class PetrichorTameableHostileEntity extends TamableAnimal implements GeoEntity {
    ...
    public PetrichorTameableHostileEntity(EntityType<? extends TamableAnimal> entityType, Level level, RawAnimation ATTACK_ANIMATION, int attackAnimationTickLength) {
        this(entityType, level, ATTACK_ANIMATION, attackAnimationTickLength, (attackAnimationTickLength / 2));
    }

    public PetrichorTameableHostileEntity(EntityType<? extends TamableAnimal> entityType, Level level, RawAnimation ATTACK_ANIMATION, int attackAnimationTickLength, int attackDamageTickDelay) {
    ...
    protected boolean isTame(LivingEntity livingEntity) {
        return super.isTame();
    }
