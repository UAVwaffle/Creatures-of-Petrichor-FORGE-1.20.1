package com.uavwaffle.creaturesofpetrichor.worldgen;

import com.uavwaffle.creaturesofpetrichor.Config;
...
public class PetrichorWorldRegistry {
    ...
    public static boolean testBiome(TagKey<Biome> entry, Holder<Biome> biome) {
        ...
        try {
            ...
            CreaturesOfPetrichor.LOGGER.warn("could not test biome config for {}, defaulting to no spawns for mob", getBiomeName(biome).getNamespace());
        }
        return result;
    }
